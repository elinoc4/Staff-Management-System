...
error_reporting(0);
	...
	if(isset($_POST['dept']))
	{
		...
		else
		{
				...
				$status = 'submitted';
				//insering data
				$query="INSERT INTO studentList (category,name,dept,regno,faculty,stage,email,status,pword)VALUES('$category','$fname', '$dept','$regno','$faculty','$stage','$email','$status','$pword')";
					...
					<div class="row">
						...
						<div class="col-md-6 " id="form">
							...
							<form class="form-horizontal " role="form" enctype="multipart/form-data" method="POST" action="register.php">
					            ...
					            <div class="form-group">
									<div class="col-md-6">
										<input type="number" name="regno" placeholder="Registration Number" id="regno" class="form-control" required autofocus>
					                </div><span class="label label-success" id="result"></span>
					            </div>
					            <div class="form-group">
									<div class="col-md-6">
					            ...
					            <div class="form-group">
									<div class="col-md-6">
										<input type="password" for="password" name="pword" id="p1" placeholder="PASSWORD" class="form-control" required autofocus>
					                </div><span class="label label-success" id="pw2"></span>
					            </div>
					            <div class="form-group">
									<div class="col-md-6">
										<input type="password" for="password" id="p2" placeholder="PASSWORD" class="form-control" required autofocus>
					                </div><span class="label label-success" id="pw2"></span>
					            </div>
					            <div class="form-group">
									<div class="col-md-6">
					            ...
					            <div class="form-group">
									<div class="col-md-6">
										<input type="submit" name="submit" id="submit" class="form-control btn-success" required autofocus>
					                </div>
					            </div>
					        </form>
					    </div>
