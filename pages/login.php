...
include"connect.php";
	...
	if ($regno !='' && $pword != '') {
		if ($table == 'staffs') {
			$query = mysqli_query($con,"SELECT * FROM $table WHERE email='$regno' AND pword='$pword'")or die('an error occurred');
					...
					<div class="row">
						...
						<div class="col-md-6 " id="form">
							...
							<form class="form-horizontal " role="form" enctype="multipart/form-data" method="POST" action="login.php">
					            ...
					            <div class="form-group">
									<div class="col-md-6">
										<input type="text" name="fname" placeholder="E-mail" class="form-control"  autofocus>
					                </div>
					            </div>
					            <div class="form-group">
									<div class="col-md-6">
					            ...
					            <div class="form-group">
									<div class="col-md-6">
										<input type="submit" name="submit"  class="form-control btn-success"  autofocus>
					                </div>
					            </div>
					        </form>
					    </div>
